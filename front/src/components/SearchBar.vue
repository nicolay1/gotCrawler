<template>
    <b-container class="search_bar">
        ...
        <div class="row">
            <ShowCard :title=title :overview=overview :pict=pict :date_next_ep=date_next_ep
                      :show_id="show_id"></ShowCard>
        </div>
    </b-container>
</template>
    ...
    export default {
        ...
        methods: {
            show_results: function (show_searched) {
                // window.location.href = 'https://fr.wikipedia.org/wiki/' + show_searched;
                axios
